"""
Django settings for duannhom project.
...
SECRET_KEY = 'django-insecure-#&sam*)yb(#-x66^*d@%i$e7uib-c69kc8($&+v6)=4(@guq-y'
...
ROOT_URLCONF = 'duannhom.urls'
import os
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'DIVA/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
